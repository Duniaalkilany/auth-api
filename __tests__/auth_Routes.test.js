...
const users = {
    admin: { username: 'admin-300', password: 'password', role: 'admin' },
    editor: { username: 'editor-300', password: 'password', role: 'editor' },
    user: { username: 'user-300', password: 'password', role: 'user' },
};
