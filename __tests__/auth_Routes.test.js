...
const users = {
    admin: { username: 'admin-13', password: 'password', role: 'admin' },
    editor: { username: 'editor-13', password: 'password', role: 'editor' },
    user: { username: 'user-13', password: 'password', role: 'user' },
};
