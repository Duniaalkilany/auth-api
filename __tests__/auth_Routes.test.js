...
const users = {
    admin: { username: 'admin-11', password: 'password', role: 'admin' },
    editor: { username: 'editor-11', password: 'password', role: 'editor' },
    user: { username: 'user-11', password: 'password', role: 'user' },
};
