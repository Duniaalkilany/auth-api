...
const users = {
    admin: { username: 'admin-180', password: 'password', role: 'admin' },
    editor: { username: 'editor-180', password: 'password', role: 'editor' },
    user: { username: 'user-180', password: 'password', role: 'user' },
};
