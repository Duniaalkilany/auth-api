...
const users = {
    admin: { username: 'admin-20', password: 'password', role: 'admin' },
    editor: { username: 'editor-20', password: 'password', role: 'editor' },
    user: { username: 'user-20', password: 'password', role: 'user' },
};
