...
const users = {
    admin: { username: 'admin-200', password: 'password', role: 'admin' },
    editor: { username: 'editor-200', password: 'password', role: 'editor' },
    user: { username: 'user-200', password: 'password', role: 'user' },
};
