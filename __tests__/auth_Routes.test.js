...
const users = {
    admin: { username: 'admin-12', password: 'password', role: 'admin' },
    editor: { username: 'editor-12', password: 'password', role: 'editor' },
    user: { username: 'user-12', password: 'password', role: 'user' },
};
